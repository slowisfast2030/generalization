...
def load_csv_data(data_path, test_path):
    ...
    # 用来拼接lsa向量
    df.to_pickle('../generalization_data/gen_data_lsa_cvjd_6108.pkl')
    return df
...
if __name__ == "__main__":
    ...
    test_path = '../generalization_data/cvjd_202208_6108.pkl'
    ...
    tfidf_lsa1.to_pickle('../generalization_data/gen_title_category_tags_tfidf_lsa.pkl')

    tfidf_lsa2 = get_tfidf_lsa_from_text_cols(data_path, test_path, col_name_list2, dimension=70)
    tfidf_lsa2.to_pickle('../generalization_data/gen_description_tfidf_lsa.pkl')

    tfidf_lsa3 = get_tfidf_lsa_from_text_cols(data_path, test_path, col_name_list3, dimension=70)
    tfidf_lsa3.to_pickle('../generalization_data/gen_requirement_tfidf_lsa.pkl')

    tfidf_lsa4 = get_tfidf_lsa_from_text_cols(data_path, test_path, col_name_list4, dimension=40)
    tfidf_lsa4.to_pickle('../generalization_data/gen_position_tfidf_lsa.pkl')

    tfidf_lsa5 = get_tfidf_lsa_from_text_cols(data_path, test_path, col_name_list5, dimension=30)
    tfidf_lsa5.to_pickle('../generalization_data/gen_skills_tfidf_lsa.pkl')
