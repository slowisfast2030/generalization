...
def get_work_duration_mean(data_path, test_path):
    '''
...
if __name__ == "__main__":
    ...
    all_data = get_work_duration_mean(data_path, test_path)
    ...
    all_data[['cv_id', 'jd_id', 'work_duration_mean']].to_pickle('../generalization_data/gen_work_duration_mean.pkl')
