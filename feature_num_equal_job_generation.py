...
def get_text_jieba_filter(data_path, test_path):
    '''
...
if __name__ == "__main__":
    ...
    all_data = get_text_jieba_filter(data_path, test_path)
    print(all_data["equal_job"])
    #print(all_data.info())

    all_data[['cv_id', 'jd_id', 'equal_job']].to_pickle('../generalization_data/gen_equal_job.pkl')
    print("all is well!")
